...
var children = [
            ...
            dataTable(
                ...
                [
                    ...
                    ['③ 平台服务费','链商平台技术+运营服务','8.00%',fmt(platCalc.platformFee),'消费者支付额','T+1到链商平台汇付商户号'],
            ...
            p('综合商城是链商平台直营的电商业务（平台子户），没有中间平台商家环节，结构最简单。'),
            dataTable(
                ['利益方','角色定义','分配比例','分配金额','说明'],
                [
                    ['① 支付渠道','微信/支付宝手续费','0.60%',fmt(ecomCalc.channelCost),'优先扣除'],
                    ['② 综合商城','链商平台直营电商收入','82.40%',fmt(ecomCalc.ecomMerchant),'最高商家分成'],
