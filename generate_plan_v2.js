...
const WORK_COLORS = {
    ...
    '商业模型':   { fill: 'E74C3C', font: 'FFFFFF', desc: '收入模型/分润机制/会员体系/财务测算' },
    ...
    return [
        ...
        { date: '2026/05/28', dayOfWeek: '四', phase: '前期·体系成型期', taskTheme: '链生活品牌体系文件集中产出',
            tasks: [
                ...
                { content: '链生活商业模式+分润机制+品牌策略+护城河体系撰写', type: '商业模型', hours: 2.5 },
            ],
            deliverables: '《定位手册》/《战略总纲》/《视觉手册》/《商业模式》/《分润模型》/《策略方案》/《护城河体系》', kpis: '品牌体系7份核心文档交付 / 总字数≥5万字', collab: '—', ai: 'Claude（全文档体系并行产出）' },
...
function generatePlanDays() {
    ...
    for (const d of days) {
        ...
        // ==================== 第5-8周占位（后续同结构展开，此处聚焦前两周细节） ====================
            ...
            const w7d = {
                31: { tasks: [['收入结构设计：5大板块定价逻辑','商业模型',2.5],['分润机制：试跑→增长→长期阶梯模型','商业模型',2.5],['会员体系设计：等级/权益/盈利逻辑','商业模型',2],['撰写《商业模式说明》','内容产出',1]], dlv: '《商业模式说明》初稿', kpi: '收入≥5板块/分润3阶段/会员≥4级', collab: '财务部', ai: 'Claude' },
...
function buildExcel() {
    ...
    const deliverables = [
        ...
        [23,'链生活分润机制与会员体系','前期','5/28','Word','—','✅ 已完成'],
