...
function generatePlanDays() {
    ...
    for (const d of days) {
        ...
        // ---- 第3-13周（精简但完整，保持与前两周同结构） ----
        else if(week===3){ entry.phaseGroup='第1月·品牌地基期'; entry.phase='品牌命名+公测反馈优化';
            const w3=[[['【公测反馈】收集公测首周品牌相关反馈：商家/消费者对品牌视觉、用语、模板的体验问题','调研分析',1.5],['命名策略制定：标准10条+关键词池','品牌创意',2],['Claude生成100+关键词（融入公测中收集的商家真实用词习惯）','品牌创意',1.5],['5向分类：连接/社区/生活/创新/融合','品牌创意',1.5],['撰写《命名策略与标准》+《公测品牌反馈周报》','内容产出',1.5]],'《品牌命名策略与标准》\n《公测品牌反馈周报①》','关键词≥100/方向≥5/反馈≥10条','合规部、数字化中心','Claude'];
            if(dayNum===11)setDay(entry,w3[0]);
            if(dayNum===12)setDay(entry,[[['Claude批量：100个候选名','品牌创意',2.5],['初筛：保留50个','品牌创意',1.5],['二次筛选：读音+品牌感→Top20','品牌创意',2],['Top20释义撰写','品牌创意',1],['内部盲选测试：3-5位同事','会议汇报',1]],'《候选名称Top20》','候选≥100/Top20各配释义/内测≥3人','','Claude']);
            if(dayNum===13)setDay(entry,[[['Top10商标局官网预查','调研分析',2],['企查查企业名冲突验证','调研分析',1.5],['域名(.com/.cn)可用性查询','调研分析',1.5],['社媒账号名可用性检查','调研分析',1.5],['撰写《商标预查报告》+合规部确认','内容产出',1.5]],'《商标预查报告》','预查≥10/5维度/风险评级','合规部','网络搜索']);
            if(dayNum===14)setDay(entry,[[['命名终稿汇报准备','会议汇报',2],['管理层评审会','会议汇报',1.5],['确定主名+备用2-3个','品牌创意',1],['撰写《品牌命名终稿》','内容产出',1.5],['启动商标注册流程','归档整理',2]],'《品牌命名终稿》/商标注册委托','主名确定/备用≥2/注册启动','管理层、合规部','']);
            if(dayNum===15)setDay(entry,[[['Slogan体系：主口号+3端','品牌创意',2],['Claude批量：每端30条→精选3条','品牌创意',1.5],['话语体系整合','内容产出',1.5],['【公测反馈】第2轮品牌反馈收集+模板使用数据汇总','调研分析',1.5],['周报+周会：公测品牌第2周状态','归档整理',1.5]],'《品牌话语体系与Slogan》\n《公测品牌反馈周报②》\n周报','Slogan≥120条/精选≥12条/反馈累计≥20条','部门周会、数字化中心','Claude']);
        }
...
function buildWeeklySheet(wb, allDays) {
    ...
    const wInfo = {
        ...
        3:{t:'品牌命名+公测反馈优化',o:'命名策略/候选Top20/商标预查/命名终稿/Slogan体系/公测品牌反馈周报×2',k:'命名获批/商标可用/注册启动/公测反馈累计≥20条',c:'合规部/管理层/数字化中心',a:'Claude+搜索'},
...
function buildDeliverablesSheet(wb) {
    ...
    const items = [
        ...
        [48,'品牌命名策略与标准','第1月','W3','Word','—','⏳ 待完成'],
        [49,'候选名称Top20','第1月','W3','Word','—','⏳ 待完成'],
        [50,'商标预查报告','第1月','W3','Word','合规部','⏳ 待完成'],
        [51,'品牌命名终稿','第1月','W3','Word','管理层','⏳ 待完成'],
        [52,'品牌话语体系与Slogan','第1月','W3-W4','Word','—','⏳ 待完成'],
        [53,'品牌战略总纲体系V1.0','第1月','W4','Word','—','⏳ 待完成'],
        [54,'品牌差异化战略说明','第1月','W4','Word','—','⏳ 待完成'],
        [55,'第1月品牌地基成果包','第1月','W4','文件夹','管理层','⏳ 待完成'],
        // 第2月
        [56,'品牌视觉策略Brief','第2月','W5','Word','设计师','⏳ 待完成'],
        [57,'Logo概念方向稿（MJ）','第2月','W5','PDF/PNG','设计师','⏳ 待完成'],
        [58,'品牌视觉与超级符号体系手册','第2月','W5','Word','设计师','⏳ 待完成'],
        [59,'Logo标准规范文件（含源文件）','第2月','W5','AI/PNG/PDF','设计师','⏳ 待完成'],
        [60,'品牌故事体系','第2月','W6','Word','—','⏳ 待完成'],
        [61,'品牌语调与文案规范','第2月','W6','Word','文案组','⏳ 待完成'],
        [62,'品牌核心页面文案','第2月','W6','Word','—','⏳ 待完成'],
        [63,'品牌内容策略与日历','第2月','W6','Word','文案组','⏳ 待完成'],
        [64,'商业模式说明','第2月','W7','Word','财务部','⏳ 待完成'],
        [65,'招商战略体系','第2月','W7','Word','—','⏳ 待完成'],
        [66,'招商手册（通用版+行业版×3）','第2月','W7','Word','合规部','⏳ 待完成'],
        [67,'商家合作SOP','第2月','W7','Word','—','⏳ 待完成'],
        [68,'品牌全案体系目录','第2月','W8','Word','—','⏳ 待完成'],
        [69,'品牌体系完整性自查表','第2月','W8','Word','—','⏳ 待完成'],
        [70,'第2月品牌全案成果包','第2月','W8','文件夹','管理层','⏳ 待完成'],
        // 第3月
        [71,'样板社区选择标准','第3月','W9','Word','—','⏳ 待完成'],
        [72,'30天冷启动动作表','第3月','W9','Word','—','⏳ 待完成'],
        [73,'单社区财务模型','第3月','W9','Excel','财务部','⏳ 待完成'],
        [74,'城市服务商管理办法','第3月','W9','Word','—','⏳ 待完成'],
        [75,'商业生态白皮书V1.0','第3月','W10','Word/PDF','—','⏳ 待完成'],
        [76,'融资路演BP（内容版+视觉版）','第3月','W10','PPT/PDF','设计师','⏳ 待完成'],
        [77,'路演话术（3版本）','第3月','W10','Word','—','⏳ 待完成'],
        [78,'社区线下物料包','第3月','W11','AI/PNG/PDF','设计师','⏳ 待完成'],
        [79,'社媒视觉素材库','第3月','W11','PSD/PNG/MP4','设计师/视频组','⏳ 待完成'],
        [80,'产品需求文档PRD','第3月','W11','Word','数字化中心','⏳ 待完成'],
        [81,'品牌使用规范手册','第3月','W11','Word/PDF','合规部','⏳ 待完成'],
        [82,'链宝IP初稿','第3月','W11','AI/PNG','设计师','⏳ 待完成'],
        [83,'品牌全案最终目录','第3月','W12','Word','—','⏳ 待完成'],
        [84,'Notion品牌资产知识库','第3月','W12','Notion','部门全员','⏳ 待完成'],
        [85,'试用期述职报告','第3月','W12-W13','Word','人事部','⏳ 待完成'],
        [86,'品牌工作交接与协作手册','第3月','W12','Word','部门全员','⏳ 待完成'],
        [87,'终期汇报PPT','第3月','W12-W13','PPT','管理层','⏳ 待完成'],
        [88,'品牌建设AI方法论总结','第3月','W13','Word','—','⏳ 待完成'],
        [89,'交接确认签字表','第3月','W13','Word','部门全员','⏳ 待完成'],
        [90,'周总结和计划报告（×16）','全程','持续','Excel','部门主管','⏳ 持续'],
        [91,'月度总结与下月计划（×3）','全程','W4/W8/W12','Word','管理层','⏳ 待完成'],
        [92,'技术沟通会议纪要（数字化中心）','第1月','W1','Word','数字化中心','⏳ 待完成'],
        [93,'跨部门协同纪要（月度汇报前对齐）','第1月','W4','Word','管理层/数字化中心/运营部','⏳ 待完成'],
        [94,'跨部门资源需求清单+协作SOP','第2月','W8','Word','设计师/视频组/数字化中心','⏳ 待完成'],
        [95,'跨部门执行对齐纪要（三方配合确认）','第3月','W9','Word','业务部/数字化中心/运营部','⏳ 待完成'],
        [96,'品牌资产交接确认签收表','第3月','W13','Word','部门主管/数字化中心/设计师','⏳ 待完成'],
        // 公测品牌冲刺交付物（新增）
        [97,'公测品牌触点清单','第1月','W1','Word','数字化中心','⏳ 待完成'],
        [98,'公测版UI品牌审查问题清单','第1月','W1','Word','数字化中心','⏳ 待完成'],
        [99,'公测品牌准备清单（4大模块）','第1月','W1','Word','数字化中心','⏳ 待完成'],
        [100,'店铺模板设计Brief（3餐饮+3电商）','第1月','W2','Word','设计师','⏳ 待完成'],
        [101,'6套店铺模板终稿（3餐饮+3电商）','第1月','W2','设计源文件','设计师/数字化中心','⏳ 待完成'],
        [102,'知识库品牌内容V1.0（图文+短视频脚本）','第1月','W2','Word/MP4','数字化中心','⏳ 待完成'],
        [103,'商家入驻品牌物料指南','第1月','W2','Word','商务/数字化中心','⏳ 待完成'],
        [104,'公测品牌准备评审纪要','第1月','W2','Word','管理层/数字化中心','⏳ 待完成'],
        [105,'公测品牌反馈周报①+②','第1月','W3','Word','数字化中心','⏳ 待完成'],
        [106,'公测模板迭代V1.1','第2月','W5','设计源文件','设计师','⏳ 待完成'],
        [107,'知识库品牌内容V2.0','第2月','W6','Word/MP4','文案组','⏳ 待完成'],
    ];
...
async function main() {
    ...
    console.log(`📊 6工作表 | 每日计划 | 甘特图色条 | 周度14周 | 月度4阶段 | 交付物107项 | AI工具6项`);
}
