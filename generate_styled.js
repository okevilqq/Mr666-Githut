...
function getPreWorkData() {
    return [
        ...
        { date:'2026/05/20', dow:'二', phase:'前期', taskTheme:'母公司体系调研',
            tasks:[['母公司企业介绍与公司架构学习（含宣传片）','调研分析',2],['2025公司介绍PPT深度研读与业务版图梳理','调研分析',2],['跨境电商+链商双赛道协同关系分析','策略规划',2],['撰写《母公司体系架构认知总结》','归档整理',2]],
            dlv:'《母公司总结》', kpi:'母公司业务版图覆盖≥6大板块 / 链商与母公司协同关系清晰' },
        ...
        { date:'2026/05/27', dow:'二', phase:'前期', taskTheme:'组织架构+协作机制+链生活概念定调',
            tasks:[['母公司&链商平台运营方组织架构完整版梳理','调研分析',2],['链商资源与协作机制沟通梳理','会议汇报',2],['链生活品牌概念设计（火星链→链生活关键转折）','品牌创意',2.5],['链生活概念方案初稿与命名定调','品牌创意',1.5]],
        ...
        { date:'2026/05/28', dow:'三', phase:'前期', taskTheme:'链生活品牌体系文件集中产出',
            tasks:[['链生活品牌定位体系战略手册','策略规划',2],['链生活品牌战略总纲体系','策略规划',2],['链生活品牌视觉与超级符号体系手册','视觉设计',1.5],['商业模式+服务费结算机制+品牌策略+护城河体系','商业模型',2.5]],
            dlv:'7份品牌核心文档（定位/总纲/视觉/商业模式/服务费结算/策略/护城河）', kpi:'7份文档同日交付 / 总字数≥5万字', ai:'Claude' },
...
function generatePlanDays() {
    ...
    for (const d of days) {
        ...
        // ---- 第3周（6/15-6/19：品牌命名收尾+营销工具定稿+品牌体系深化） ----
            ...
            // Day 11 (6/15 Mon) — 已完成 ✅
            if(dayNum===11)setDay(entry,[[['✅ 品牌命名终稿确定：赋商通（历经V2→V3→V4→赋商版5轮迭代）','品牌创意',2],['✅ 商标注册启动：第35/42/9类，委托北京捷佳联合，¥2,000','归档整理',2],['✅ 市场拓展营销工具包 V1.0 交付（5部分21章，docx格式）','内容产出',2.5],['✅ 招商会销讲PPT生成脚本完成（29页，pptx格式，含演讲备注+Q&A）','内容产出',1.5]],'赋商通命名终稿\n商标注册代理协议（IP-2026-001）\n市场拓展营销工具包 V1.0\n招商会销讲PPT V1.0','品牌名确定/商标3类提交/工具包21章/PPT 29页','合规部、北京捷佳联合','Claude']);
            // Day 12 (6/16 Tue) — 明日
            if(dayNum===12)setDay(entry,[[['Slogan体系完善：基于赋商通品牌名生成3端口号（消费者/商家/推广者）','品牌创意',2],['Claude批量：每端20条→精选3条，含释义与应用场景','品牌创意',2],['招商会销讲PPT审阅：29页逐页检查+演讲备注完善+过渡语优化','内容产出',2],['品牌话语体系整合：命名+Slogan+定位语+电梯演讲统一口径','内容产出',1.5],['商标注册进度跟进：确认钉钉审批+乙方（捷佳联合）进度','归档整理',0.5]],'《品牌话语体系与Slogan》（赋商通版）\n《招商会PPT V1.1》修订版','Slogan≥60条候选/精选≥9条/PPT审阅完成/商标审批推进','管理层（钉钉审批）','Claude']);
            // Day 13 (6/17 Wed)
            ...
            // Day 14 (6/18 Thu)
            if(dayNum===14)setDay(entry,[[['品牌视觉一致性审查：跨全部文档的色彩/字体/Logo使用规范性检查','视觉设计',2.5],['服务费结算模型V3.2对外版定稿：投资人版+商家版双版本口径统一','内容产出',2],['画册Brief V3.0与市场工具包交叉对照：内容去重+缺失补充清单','归档整理',1.5],['合同档案归档确认：IP-2026-001整理+未来合同模板框架准备','归档整理',2]],'《品牌视觉一致性审查报告》\n《服务费结算模型V3.2对外版》双版本\n合同档案归档确认','视觉审查≥10文档/服务费结算对外版2版本/合同归档完整','财务部（服务费结算口径确认）','Claude']);
            // Day 15 (6/19 Fri)
        ...
        // ---- 第5-13周 ----
            ...
            if(dayNum===31)setDay(entry,[[['收入结构设计：5大板块','商业模型',2.5],['服务费结算机制：试跑→增长→长期阶梯','商业模型',2.5],['会员体系：等级/权益/盈利','商业模型',2],['撰写《商业模式说明》','内容产出',1]],'《商业模式说明》初稿','收入≥5/服务费结算3阶段/会员≥4级','财务部','Claude']);
...
function buildWeeklySheet(wb, allDays) {
    ...
    const wInfo = {
        ...
        3:{t:'品牌命名定稿+工具包交付+体系深化',o:'赋商通命名终稿/商标注册启动/市场拓展工具包V1.0/招商会PPT V1.0/Slogan话语体系/执行手册审阅/合规审查/视觉一致性审查/服务费结算对外版',k:'品牌名确定/商标3类提交/工具包21章/PPT29页/新增≥8份文档',c:'管理层/合规部/数字化中心/财务部/北京捷佳联合',a:'Claude'},
...
function buildDeliverablesSheet(wb) {
    ...
    const items = [
        ...
        [20,'母公司&链商平台运营方组织架构完整版','前期','5/27','Word','—','✅ 已完成'],
        ...
        [27,'链生活服务费结算机制与会员体系','前期','5/28','Word','—','✅ 已完成'],
        ...
        [48,'赋商通命名终稿（5轮迭代）','第1月','W3','Word','管理层','✅ 已完成'],
        ...
        [52,'品牌话语体系与Slogan（赋商通版）','第1月','W3','Word','—','⏳ 待完成'],
        [53,'品牌执行手册 V1.1 + 千面千店文案规范','第1月','W3','Word','—','⏳ 待完成'],
        [54,'全平台合规术语审查 + 视觉一致性审查','第1月','W3','Word','—','⏳ 待完成'],
        [55,'服务费结算模型V3.2对外版（双版本）','第1月','W3','Word','财务部','⏳ 待完成'],
...
async function main() {
    ...
    const outPath = path.join(__dirname, 'Mr666_3个月品牌全案工作计划表.xlsx');
