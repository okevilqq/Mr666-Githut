...
function buildWeeklySheet(wb, allDays) {
    ...
    const wInfo = {
        ...
        3:{t:'品牌命名定稿+工具包交付+体系深化',o:'链邦赋商通命名终稿/商标注册启动/市场拓展工具包V1.0/招商会PPT V1.0/Slogan话语体系/执行手册审阅/合规审查/视觉一致性审查/服务费结算对外版',k:'品牌名确定/商标3类提交/工具包21章/PPT29页/新增≥8份文档',c:'管理层/合规部/数字化中心/财务部/北京捷佳联合',a:'Claude'},
