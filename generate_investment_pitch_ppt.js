...
// 赋商通（链商2.0）招商会销讲PPT逐页脚本 · 完整演示版
//
// 输出：20260615 市场拓展营销工具包/赋商通_招商会销讲PPT_V1.0.pptx
//
...
const OUT_FILE = path.join(OUT_DIR, '赋商通_招商会销讲PPT_V1.0.pptx');
...
contentSlide(
    ...
    [
        ...
        { text: '顾客还会忘吗？——这就是赋商通', level: 0, color: BRAND.DEEP_BLUE, bold: true },
    ],
    '【讲述要点·P02 · 约1分钟】\n' +
...
contentSlide(
    ...
    '\n' +
    '【过渡语】\n' +
    '"这么大的市场，需要一个什么样的平台？——我们来介绍赋商通。" → 翻P05',
    { pageNum: 'P04' }
);
...
contentSlide(
    ...
    [
        ...
        { text: '赋商通 = 面向社区商业的数字经营平台', level: 0, bold: true, color: BRAND.CHAIN_RED },
...
contentSlide(
    ...
    [
        ...
        { text: '', level: 0 },
        { header: true, text: '④ 交易即服务费结算 · 零固定费用', color: BRAND.GREEN },
    ...
    '3. ①→④有递进关系：独立经营是基础→会员互通是纽带→跨店通兑是壁垒→交易即服务费结算是信任\n' +
    '\n' +
    '【过渡语】\n' +
...
contentSlide(
    ...
    [
        ...
        { text: '交易即服务费结算：平台仅在实际交易发生时获取服务费', level: 0 },
    ],
    '【讲述要点·P07 · 约2分钟】\n' +
...
contentSlide(
    '跨店通兑——在A店获券，在B店使用',
    [
        { subtitle: true, text: '全生态会员权益互通体系 · 赋商通核心壁垒', color: BRAND.CHAIN_RED, size: 18 },
        { text: '', level: 0 },
    ...
    '5. 可补充类比："就像银联——你的银行卡在任何ATM都能取钱，因为网络是互通的。赋商通要做社区消费权益的‘银联’。"\n' +
    '\n' +
    '【过渡语】\n' +
...
var qaData = [
    ...
    { q: '平台能撑多久？资金够吗？', a: '母公司提供战略资金支持。盈亏平衡仅需40,500笔/月——财务模型健康，轻资产模式资金需求小。根据发展需要适时启动外部融资。' },
    ...
    { q: '你们融过资吗？下一轮什么时候？', a: '目前由母公司战略支持。根据业务发展需要——Phase 1验证PMF → 适时启动首轮融资。今天在座的各位有机会参与早期。' },
...
contentSlide(
    ...
    [
        ...
        { text: '"各位下午好，欢迎来到赋商通招商说明会。我是今天的主讲人[姓名]。"', level: 0 },
        { text: '', level: 0 },
        ...
        { text: '"我是[姓名]，[职位]。今天我会用30分钟，带大家了解——赋商通是什么、为什么现在加入、以及如何合作。"', level: 0 },
        { text: '', level: 0 },
