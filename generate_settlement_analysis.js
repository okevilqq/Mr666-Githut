...
var children = [
            ...
            infoTable([
                ...
                ['关联文档','《链商平台2.0系统技术会议纪要》《品牌执行手册》《法律合规框架》《消费权益×服务费结算模型融合策略》'],
            ]),
            divider(),
            ...
            b('合规层面存在重大风险：当前"链商平台核销备付金账户"作为所有资金的中转枢纽，涉嫌构成"资金池"模式，违反平台合规红线第2条（不可形成资金池）；"先收后分"的资金流转模式存在"二清"（二次清算）合规风险'),
            ...
            h2('2.1  三大商家类型与分账结构'),
            p('链商平台采用"大平台→平台商家→联盟商家"三层架构，涉及三种商家主体：平台商家（拥有独立主体小程序，如老树根餐饮、玖玖餐饮）、联盟商家（围绕平台商家的中小商户，如XXX沐足）、综合电商（链商平台运营方直营的电商业务，使用平台子户）。每种商家类型对应四种分账场景，共12个子模型。'),
            ...
            p('↓',{alignment:AlignmentType.CENTER,size:24}),
            flowBox('链商平台核销备付金汇付账户（普通商户）⚠️ 红色标注·资金汇聚点', true),
            p('↓          ↓          ↓',{alignment:AlignmentType.CENTER}),
            flowBox('平台商家账户\n（老树根/玖玖）', false),
            flowBox('联盟商家账户\n（XXX沐足等）', false),
            flowBox('综合电商账户\n（平台子户）', false),
            ...
            divider(),
            calloutBox('关键发现', [
                '所有资金流经"链商平台核销备付金汇付账户（普通商户）"——这是drawio中唯一红色标注的节点',
                '该账户实质上承担了"资金中转池"的角色：消费者付款→备付金账户→分账给各方',
                '汇付体系内的同一个顶级商户号下，所有子商户号可以相互分账；平台子户每个主体限开5个',
            ]),
            pageBreak(),
            ...
            dataTable(
                ['评估维度','风险等级','说明'],
                [
                    ['资金池风险','🔴 高危','"链商平台核销备付金账户"作为所有资金汇聚和中转节点，符合监管对"资金池"的定义特征——消费者资金先汇集到平台控制的账户再分配，而非直接结算给商户'],
            ...
            flowBox('消费者 ──付款──→ 链商平台备付金账户（平台控制）──分账──→ 各商家账户', true),
            ...
            calloutBox('关键变更', [
                ...
                '链商平台仅负责：生成分账指令 → 传给汇付 → 汇付执行分账',
                '变更术语："备付金账户" → "汇付监管分账账户"；"链商平台金融" → "链商平台服务"',
            ...
            dataTable(
                ['场景','原比率','修订后','修订理由'],
                [
                    ['充值-汇付收单','电商82.4% / 备付17.6%','电商100%（服务费0%）','综合电商是链商平台直营，充值即为自有资金；服务费从消费端收取'],
            ...
            dataTable(
                ...
                [
                    ...
                    ['4','术语是否合规','是否已按《法律合规框架》术语表替换所有敏感词汇？是否避免了"币/Token/投资回报/稳赚"等禁用词？','Mr666\n+ 法务','术语合规'],
                    ['5','是否承诺收益','对外材料中是否出现任何形式的收益承诺（包括暗示）？是否使用"稳赚/躺赚/保本"等词汇？','Mr666\n+ 法务','无收益承诺'],
            ...
            dataTable(
                ...
                [
                    ...
                    ['链商平台核销备付金账户','汇付监管分账账户','"备付金账户"暗示平台持有客户资金；实际应为持牌支付机构的监管账户','技术文档/流程图'],
            ...
            new Table({width:{size:100,type:WidthType.PERCENTAGE},rows:[
                ...
                new TableRow({children:[
                    ...
                    new TableCell({children:[new Paragraph({children:[new TextRun({text:'🔴 当前存在风险：链商平台核销备付金账户作为资金汇集节点，构成事实上的资金池。消费者资金在备付金账户停留期间形成沉淀。',size:17,font:FONT.body,color:C.RED})],spacing:{before:15,after:15}})]}),
            ...
            p(''),
            infoTable([
                ['编制','Mr666（企业宣传部）______ 日期：2026/6/3'],
