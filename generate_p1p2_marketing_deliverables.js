...
function buildDocument() {
    ...
    children.push(
        ...
        dataTable(
            ...
            [
                ...
                ['信息深度需求', '浅层（一眼看懂利益）', '深层（费率/服务费结算/数据/案例）', '中层（机制/收益/培训/支持）'],
    ...
    var bPortal = [
        ...
        ['服务费结算透明区', '每¥100消费的完整服务费结算路径图（消费者→汇付→9方拆分）— 商家到手82.4-85% 醒目展示'],
    ...
    var pPortal = [
        ['Hero区', '主标题「分享社区好店，获得持续收入」+ 副标题「0元加入·无会员费·按真实交易服务费结算」+ CTA「成为推广者」'],
        ['信任建立区（第一屏！）', '与传销的本质区别（5维对比表：入门门槛/收入来源/层级限制/产品服务/收入保障）— 这是P端的最大转化障碍'],
        ['收益机制区', '三级角色（推广者/服务站/城市服务商）的收益对比+案例模拟："拓展10家店月均¥X收入"'],
        ['How It Works（4步）', '注册认证→拓展商家→商家产生交易→获得服务费结算。每步配手机界面截图。'],
        ['支持体系区', '①推广素材库（海报/话术/视频）②培训课程 ③数据看板（实时查看服务费结算）④晋升路径'],
    ...
    children.push(dataTable(
        ...
        [
            ['首要任务', '利益可视化（一眼看懂好处）', '费率对比+服务费结算透明（数据说服）', '去传销化信任建立（合法证明）'],
    ...
    children.push(
        ...
        n(4, '链商独有标签区（4个绿底标签）：✓跨店通兑权益体系 ✓千面千店品牌定制 ✓汇付持牌资金托管 ✓交易即服务费结算零预充值'),
    ...
    children.push(
        ...
        dataTable(
            ...
            [
                ...
                ['商家服务费计算规则', '"商家服务费计算规则"（替代"分润算法优化引擎"）', '🔵 -2', '过于官僚化，"规则"听起来像限制而非赋能。', '可改为"智能服务费系统"或"自动服务费结算引擎"'],
        ...
        dataTable(
            ...
            [
                ...
                ['服务费结算引擎', '分润算法优化引擎', '商家服务费计算规则', '智能服务费结算系统 / 自动服务费结算引擎', 'B端·招商'],
