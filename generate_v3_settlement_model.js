...
var outFile = path.join(outDir, '链商平台_服务费结算与核销模型_V3.2_跨店通兑版.docx');
...
var ECOM_BASE = {
    channelCost:          0.006,  //  0.60%  支付渠道
    ecomMerchant:         0.779,  // 77.90%  综合商城(链商平台直营)(↓0.5%)
...
var children = [
            ...
            new Paragraph({children:[new TextRun({text:'服务费结算与核销模型 V3.2',size:40,font:FONT.body,bold:true,color:C.MAIN})],alignment:AlignmentType.CENTER,spacing:{after:20}}),
            new Paragraph({children:[new TextRun({text:'跨店通兑版 · 千面千店 · 交易即服务费结算',size:28,font:FONT.body,bold:true,color:C.MAIN})],alignment:AlignmentType.CENTER,spacing:{after:30}}),
            ...
            infoTable([
                ...
                ['文档性质','链商平台服务费结算与核销模型 V3.2 · 跨店通兑版 · 千面千店 · 交易即服务费结算'],
                ['文档版本','V3.2（基于 V3.1 新增：跨店通用权益结算 + 千面千店页面设计规范 + 交易即服务费结算原则正式确立）'],
                ['编制日期','2026年6月6日（内测反馈更新）'],
                ['编制人','Mr666（企业宣传部）'],
                ['核心升级','① 跨店通用权益结算(代金券/积分/消费金全平台通用) ② 千面千店页面设计规范(三级信息密度) ③ 交易即服务费结算原则正式确立 ④ 消费流转体系(平台→联盟→商城软性引导) ⑤ 全生态会员权益互通体系'],
            ...
            n(3,'🆕 交易即服务费结算原则正式确立：平台仅在实际交易发生时获取服务费——零固定费用、零预充值、零资金占用。"商家先盈利，平台后服务费结算"——平台5-6%服务费仅在每笔交易分账时提取。',{bold:true}),
            ...
            dataTable(
                ...
                [
                    ...
                    ['平台服务费','¥5.00','-¥0.01','¥4.99','T+1','链商平台汇付商户号→银行'],
            ...
            dataTable(
                ...
                [
                    ...
                    ['平台服务费','5.00%',fmt(PLAT_HUIFU.dist.platformFee),'¥4.99','平台运营收入(含积分成本)','T+1到链商平台汇付商户号'],
            ...
            // --- 4.3 E-commerce ---
            h2('4.3  综合商城场景（3支付方式）'),
            p('综合商城为链商平台运营方直营电商业务（平台子户），无平台商家中介，结构最简洁。'),
            divider(),
            ...
            dataTable(
                ...
                [
                    ...
                    ['综合商城(链商平台直营)','77.90%',fmt(ECOM_HUIFU.dist.ecomMerchant),'¥77.82','最高商家分成(↓0.5%让给城市服务商)'],
            ...
            calloutBox('三级管理关系要点', [
                ...
                '⚠️ 层级合规：平台→城市服务商→服务站→推广者，共3层服务费结算——符合《禁止传销条例》≤3层要求',
            ]),
            divider(),
            ...
            dataTable(
                ...
                [
                    ...
                    ['服务费结算层级是否≤3','是','平台→城市服务商→服务站→推广者\n共3层分配(含平台=4节点3层)✅'],
            ...
            dataTable(
                ...
                [
                    ...
                    ['平台服务费账户','链商平台运营方','平台服务费(5%-6%)','技术/运营/人员成本','T+1·提现费0.1%'],
            ...
            dataTable(
                ...
                [
                    ...
                    ['服务费结算','分账/服务费分配','全部文档','"服务费结算"可能涉嫌收益承诺'],
            ...
            dataTable(
                ['日期','版本','调整内容','调整原因','审批人'],
                [
                    ['2026/6/3','V1.0','初始分析：12子模型还原+12问题识别','模型分析','Mr666'],
            ...
            new Paragraph({children:[new TextRun({text:'本报告为链商2.0·链生活品牌 V3.2 服务费结算与核销模型（跨店通兑版），链商2.0定位：面向社区商业的数字经营平台——商户独立经营·生态会员互通·消费权益流转·真实交易激励。',size:16,font:FONT.body,color:C.GRAY})],alignment:AlignmentType.CENTER,spacing:{after:20}}),
...
// ========== GENERATE ==========
buildAndWrite(children, outFile, { title: '链商平台 服务费结算与核销模型 V3.2 跨店通兑版' }).then(function(outPath) {
    ...
    console.log('   附录F  交易即服务费结算原则 🆕（三方利益关系+消费时序引导+可持续商业模型）');
    console.log('');
    ...
    console.log('   ★ 交易即服务费结算原则正式确立：零固定费用·零预充值·零资金占用');
