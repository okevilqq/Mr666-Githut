...
var HeadingLevel = docx.HeadingLevel, ShadingType = docx.ShadingType, PageBreak = docx.PageBreak;
...
function pct3(num) { return num.toFixed(1) + '%'; }
...
docChildren.push(new Paragraph({children:[new TextRun({text:'链商2.0 · 链生活品牌',size:28,font:'微软雅黑',color:C.GRAY})],alignment:AlignmentType.CENTER,spacing:{after:40}}));
docChildren.push(new Paragraph({children:[new TextRun({text:'¥100消费 分账与核销模型详解',size:42,font:'微软雅黑',bold:true,color:C.MAIN})],alignment:AlignmentType.CENTER,spacing:{after:10}}));
docChildren.push(new Paragraph({children:[new TextRun({text:'12场景全景：3业态 × 4支付方式',size:28,font:'微软雅黑',bold:true,color:C.ORANGE})],alignment:AlignmentType.CENTER,spacing:{after:400}}));
...
docChildren.push(new Paragraph({children:[new TextRun({text:'—— 文档结束 ——',size:18,font:'微软雅黑',color:C.GRAY,italics:true})],alignment:AlignmentType.CENTER,spacing:{before:200}}));
docChildren.push(new Paragraph({children:[new TextRun({text:'本报告基于链商平台V15扩展模型（2026-06-06），以¥100消费为基准场景，',size:16,font:'微软雅黑',color:C.GRAY})],alignment:AlignmentType.CENTER,spacing:{after:10}}));
docChildren.push(new Paragraph({children:[new TextRun({text:'涵盖平台商家·联盟商家·综合电商三种业态下4种支付方式的12场景完整分账与核销机制。',size:16,font:'微软雅黑',color:C.GRAY})],alignment:AlignmentType.CENTER,spacing:{after:10}}));
docChildren.push(new Paragraph({children:[new TextRun({text:'核心新增：① 4支付方式全覆盖 ② 分润7方角色矩阵 ③ 代金券不可跨平台商家使用（新规）。',size:16,font:'微软雅黑',color:C.MAIN})],alignment:AlignmentType.CENTER,spacing:{after:20}}));
docChildren.push(new Paragraph({children:[new TextRun({text:'代金券/积分/消费金均不可兑现，严守三条合规红线：积分不可兑现 · 不可形成资金池 · 不可承诺收益。',size:16,font:'微软雅黑',color:C.RED})],alignment:AlignmentType.CENTER}));
docChildren.push(new Paragraph({children:[new TextRun({text:'生成日期：2026年6月6日 · 编制：梁君衡 · 企业宣传策划部 · 链邦科技',size:16,font:'微软雅黑',color:C.GRAY})],alignment:AlignmentType.CENTER,spacing:{before:40}}));
...
Packer.toBuffer(doc).then(function(buffer) {
    ...
    console.log('');
    console.log('✅ Document generated: ' + outFile);
